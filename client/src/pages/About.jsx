...
export const About = () => {
  ...
  <div className="grid md:grid-cols-3 gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
    ...
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      <p className="text-2xl text-yellow-500">Our Team Details</p>
      <p className="pt-3">
       

        {" "}<ui>
          <li>Faisal Shaikh 64  1032231524 </li>
          <li>Naman Sharma  38  1032230536 </li>
          <li>Mahek somlapurkar 45  1032230619 </li>
          <li>Atharva Pisal 39  1032230537 </li>
          <li>Atharva parchure </li>
