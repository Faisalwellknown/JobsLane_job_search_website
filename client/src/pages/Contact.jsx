      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            ...
            <Card
              title="Address"
              content="JobLane, Swargate  Pune, Maharashtra"
            />
            <Card
              title="Email"
              content={[
                ...
                "If all this Fail to connect then only call/email  Faisal Shaikh: 9359899134, faisalshaikhikjf@gmail.com"
              ]}
            />
            <Card
              title="Phone"
              content={[
                "Customer Support Head Mahek: +123-456-7890",
                "HR & Job Inquiries contact Faisal Shaikh  : +123-456-7891",
              ]}
            />
